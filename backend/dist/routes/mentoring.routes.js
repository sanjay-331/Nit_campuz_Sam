...
router.get('/my-mentees', (0, auth_middleware_1.requireRole)([client_1.UserRole.STAFF, client_1.UserRole.HOD, client_1.UserRole.ADMIN]), mentoring_controller_1.getMyMentees);
...
router.post('/assignments/bulk', (0, auth_middleware_1.requireRole)([client_1.UserRole.HOD, client_1.UserRole.ADMIN]), mentoring_controller_1.bulkUpdateMentorAssignments);
